				...
				subLinks: [
					{
						...
						icon: IconHourglass,
						path: "/admin/elections/current",
					},
					{
						id: "upcoming-elections",
						label: "Upcoming Elections",
						icon: IconClock,
						path: "/admin/elections/upcoming",
					},
					{
						id: "past-elections",
			...
			},
			{
				...
				subLinks: [
					...
					},
					{
						...
						label: "Voter Groups",
						icon: IconUserCircle,
						path: "/admin/voters/groups",
					},
					{
						id: "voter-authentication",
						label: "Voter Authentication",
						icon: IconFingerprint,
						path: "/admin/voters/auth-config",
					},
				],
			},
			{
				...
				subLinks: [
					{
						...
						icon: IconUserCog,
						path: "/admin/candidates/manage",
					},
					{
						id: "candidate-profiles",
						label: "Candidate Profiles",
						icon: IconAddressBook,
						path: "/admin/candidates/profiles",
					},
				],
			},
			{
				...
				subLinks: [
					...
					},
					{
						...
						icon: IconUsersGroup,
						path: "/admin/results/turnout",
					},
					{
						id: "election-audit-trail",
						label: "Audit Trail",
						icon: IconClipboardText,
						path: "/admin/results/audit",
					},
				],
			},
			{
