...
const FormStepperComponent = () => {
	...
	const form = useForm({
		...
		defaultValues: {
			...
			academicYear: "",
			responsibleBody: "",
			academicLevels: undefined,
			customCriteriaDescription: "",
			departments: [],
			authMethods: [],
			enrollmentStatus: "Currently Enrolled",
			minCGPA: undefined,
			voteAnonymity: "Fully Anonymous",
			customCriteriaEnabled: false,
			academicLevelRequired: false,
			specificDepartments: false,
			ballotEncryptionEnabled: true,
			uniqueBallotPerVoter: true,
	...
	const { mutate, isPending } = useMutation(
		orpcReactQuery.election.create.mutationOptions(),
	);
